<h2>Changement de mot de passe Étape 2</h2>
<div class="col-md-8 col-md-8 col-sm-6">
    <p><img src="images/email.png" alt="mail" style="float:left">Super! Nous progressons. Un mail vient d'être envoyé à votre adresse <a href="mailto:{$identite.mail}">{$identite.mail}</a> (est-ce bien votre adresse?).</p>
