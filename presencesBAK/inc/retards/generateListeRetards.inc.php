...
$listeSanctions = $Presences->getSanctions2dates($debut, $fin, $niveau, $classe, $matricule);
// liste des $ref et des dates de sanctions correspondantes
$listeRefsDates = $Presences->listeRefsDates($listeSanctions);

$smarty->assign('listeRetards', $listeRetards);
$smarty->assign('listeSanctions', $listeSanctions);
$smarty->assign('listeRefsDates', $listeRefsDates);
