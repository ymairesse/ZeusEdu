...
switch ($action) {
	// on a dû sélectionner l'un des titulaires de la classe
	case 'selectTitu':
	...
	default:
		...
		if ($groupe != Null) {
			...
			switch ($nbTitulaires) {
				case 0: // on n'a pas de titulaire pour ce groupe
					$smarty->assign("corpsPage","noTitu");
					break;
				case 1: // un seul titulaire
					$acronyme = array_keys($listeTitulaires);
					$acronyme = $acronyme[0];
					break;
				default: // plus que un seul titulaire
