		...
		<div class="row">
			...
			<div class="col-md-5 col-sm-12">
				...
				<div class="input-group">
					...
					<input type="text" name="parent" id="parent" maxlength="40" value="Parents" placeholder="Correspondant" class="form-control"> {else} {* c'est une justification d'absence "classique" *}
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-group">
							...
							<input id="datepicker" type="text" class="form-control" placeholder="Date" value="{$dateDebut}" maxlength="10">
						</div>
						<!-- input-group -->
					</div>
					<!-- controls -->
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#presencesJour").on("change", ".statut_all", function(event) {
			...
			var background = $(this).find('option:selected').data('background');

			var tr = $(this).closest('tr');
			tr.find('td').css('color', color);
			tr.find('td').css('background', background);
			tr.find('select').val(statut);
			tr.find('input.modif').val('oui');
			tr.find('img').show();
		...
		$("#presencesJour").on("change", ".statut", function() {
			...
			$(this).parent('td').css('color', color);
