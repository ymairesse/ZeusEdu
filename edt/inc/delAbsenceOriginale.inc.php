...
// startTime nécessaire pour rétablir le statut de l'heure qui avait été déplacée
...
// suppression de l'absene originale 
$nb = $Edt->delAbsenceOriginale($abreviation, $dateSQL, $heure, $startTime);
