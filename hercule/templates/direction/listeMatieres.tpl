    ...
    <tbody>
        ...
        <tr>
            <td>
                ...
                <div class="small" {if $unCours.nbheures <= 2} style="display:none"{/if}>
            ...
            <td class="detailsCours">
                ...
                <div class="checkbox" {if $unCours.nbheures <= 2} style="display:none"{/if}>
				...
				<div class="input-group" {if $unCours.nbheures <= 2} style="display:none"{/if}>
					<input type="text"
