...
CKEDITOR.dialog.add('videoembedDialog', function (editor) {
    return {
        ...
        contents: [
            {
                ...
                elements: [
                    ...
                    },
                    {
                        type: 'text',
                        id: 'url_video',
                        label: 'URL (ex: https://www.dailymotion.com/video/x6awez8)',
        ...
        onOk: function () {
            ...
            if (url.length > 1) {
                var iframe = new CKEDITOR.dom.element.createFromHtml('<iframe frameborder="0" width="360" height="200" src="' + url + '" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>');
