...
class Bulletin
{
    ...
    private function resetLocks()
    {
        ...
        $resultat = $connexion->exec($sql);require INSTALL_DIR.'/inc/classes/class.pdfrotate.php';
        Application::DeconnexionPDO($connexion);
        if ($resultat) {
            return true;
        } else {
     ...
     * donnés. Pour un bulletin donnérequire INSTALL_DIR.'/inc/classes/class.pdfrotate.php';
     */
...
require INSTALL_DIR.'/inc/classes/class.pdfrotate.php';
    ...
    public function calculeNouvellesSituations($listeSituations, $listeGlobalPeriodePondere, $bulletin)
    {
     ...
     public function enregistrerSituations($listeSituations, $bulletin)
     {
         ...
         Application::DeconnexionPDO($connexion);require INSTALL_DIR.'/inc/classes/class.pdfrotate.php';
     }
    ...
    */
     ...
     * pour le certificatif et le formatifrequire INSTALL_DIR.'/inc/classes/class.pdfrotate.php';
     * par période.
     *
     * @param $coursGrp
     * @param $listeCompetences
