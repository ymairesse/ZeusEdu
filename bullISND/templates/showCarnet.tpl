...
<div id="barreOutils" class="noprint">
	...
	<a type="button" class="btn btn-primary pull-left" href="index.php?action=carnet&mode=oneClick">Bulletin one click <span class="glyphicon glyphicon-thumbs-up"></span></a>
	
	<div class="btn-group pull-right">
		<button class="btn btn-primary" id="boutonPlus"><span class="glyphicon glyphicon-plus" style="font-size:1.3em"></span> Ajouter une cote</button>
		<button type="button" id="enregistrer" class="btn btn-primary disabled"><span class="glyphicon glyphicon-floppy-disk" style="font-size:1.3em"></span> Enregistrer</button>
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12">
							...
							<div class="input-group">
								...
								<p class="spRemarque form-control-static"></span>
							</div>
