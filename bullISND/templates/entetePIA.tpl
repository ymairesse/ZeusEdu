...
<p><strong style="font-size:1.5em">{$listeEleves.$matricule.nom} {$listeEleves.$matricule.prenom}</strong><br>
né(e) à <strong>{$listeEleves.$matricule.commNaissance}</strong><br>
le <strong>{$listeEleves.$matricule.DateNaiss}</strong><br>
Sexe: {$listeEleves.$matricule.sexe}</p>

<p>Responsable légal: <br>
<strong>{$listeEleves.$matricule.nomResp}</strong><br>
{$listeEleves.$matricule.adresseResp}<br>
{$listeEleves.$matricule.cpostResp} {$listeEleves.$matricule.localiteResp}
</p>
