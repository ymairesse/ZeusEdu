<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-12">
			...
			<form name="formSuppr" action="index.php" method="POST" id="formSuppr" style="width:35em; float:left">
			...
			<h3 title="matricule {$matricule}">Programme actuel de cours de {$eleve.nom} {$eleve.prenom} : {$eleve.classe}</h3>
				...
				<select name="listeCoursGrp[]" multiple="multiple" id="listeCoursGrp" size="{$size}">
				...
				<br>
				<input type="submit" name="Supprimer" id="supprimer" value="Supprimer le(s) cours sélectionné(s) >>>">
				{else}
		...
		<div class="col-md-6 col-sm-12">
			...
			<form name="formAjout" action="index.php" method="POST" id="formAjout" style="float:right">
			...
			<select id="listeCours" name="listeCours" size="10" style="float:left">
			...
			{foreach from=$listeTousCours key=cours item=details}
				...
				<select id="cg{$cours}" name="choixCoursGrp" size="{$size+1}" class="choixCoursGrp">
			...
			{/foreach}
			<input type="submit" name="ajouter" id="ajouter" value="<<< Ajouter le cours sélectionné" style="display:block; clear:both">
			<input type="hidden" name="matricule" value="{$matricule}">
			<input type="hidden" name="classe" value="{$classe}">
			<input type="hidden" name="action" value="admin">
			<input type="hidden" name="mode" value="programmeEleve">
