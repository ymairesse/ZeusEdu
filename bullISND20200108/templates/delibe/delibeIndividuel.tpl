<div class="container">
	...
	<div class="row">
		...
		<div class='col-md-2 col-sm-12'>
			...
			{if $EBS.$matricule.troubles != Null}
			<h3>Troubles EBS <i class="fa fa-user-circle-o pull-right" style="color:#f00;"></i></h3>
			
			{', '|implode:$EBS.$matricule.troubles}
			{/if}
			
			{if $EBS.$matricule.amenagements != Null}
			<h3>Aménagements</h3>
			{', '|implode:$EBS.$matricule.amenagements}
			{/if}
			
			{if $EBS.$matricule.memo != ''}
			<h3>Mémo</h3>
			{$EBS.$matricule.memo}
			{/if}
