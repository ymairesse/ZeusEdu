<div id="modalShowEditValve" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modalShowMessageLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="modalShowMessageLabel">{$notification.objet}</h4>
      </div>
