<div class="container-fluid hidden-print">
	...
	<div class="collapse navbar-collapse" id="barreNavigation">
		...
		<ul class="nav navbar-nav">
			...
			<li><a href="index.php?action=notifications">Mes valves{if $unRead|@count > 0} <span class="badge unread">{$unRead|@count|default:0}</span>{/if}</a></li>
			<li><a href="index.php?action=envoiMessages">Envoi de messages</a></li>
