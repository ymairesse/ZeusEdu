...
<a href="index.php?action=news&amp;mode=edit" style="float:right" class="newInfo fauxBouton" title="Ajouter une news">
	<img src="../images/iconPlus.png" alt="+"></a>
{else}
<div>
{foreach from=$flashInfos item="uneInfo"}
	<div id="flashInfo{$uneInfo.id}">
		...
		{if $userStatus == 'admin'}
			<a style="float:left" href="index.php?action=news&amp;mode=edit" class="newInfo"><img src="../images/iconPlus.png" alt="+"></a>
