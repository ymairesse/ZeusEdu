...
// $locked défini comme une chaîne dans jdcCours.tpl
$locked = (Application::dateMySql($laDate) < Application::dateMySql(Application::dateNow())) ? "true" : "false";
...
// afficher le calendrier et l'éditeur de JDC
