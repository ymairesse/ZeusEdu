...
<form name="editJdc" id="editJdc" class="form-vertical">
    ...
    <div class="form-group">
        ...
        <textarea name="enonce" id="enonce" class="form-control" rows="4" cols="40" placeholder="Votre texte ici">{$travail.enonce|default:''}</textarea>
    </div>
    ...
    <input type="hidden" name="cible" value="{$travail.cible}">
...
$(document).ready(function(){
    ...
    // var editor = CKEDITOR.instances.enonce;
    // console.log(editor);
