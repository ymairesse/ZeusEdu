...
<script type="text/javascript">
        ...
        Dropzone.options.myDropZone = {
            ...
            acceptedFiles: "image/jpeg,image/png,image/gif,application/pdf,.psd,.doc,.rtf,.docx,.xls,.xlsx,.ppt,.pptx,.odt,.ods,.odp,.odg,.csv,.txt,.pdf,.zip,.7z,.ggb,.mm,.xcf,.xmind,.mp3",
