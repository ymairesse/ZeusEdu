...
<div class="row">
    <ul class="nav nav-tabs">
      ...
      <li><a data-toggle="tab" href="#tabs-1">Classes <span class="badge">{$listeClasses|count}</span></a></li>
      <li><a data-toggle="tab" href="#tabs-2">Niveau <span class="badge">{$listeNiveaux|count}</span></a></li>
      <li><a data-toggle="tab" href="#tabs-3">École <span class="badge">{$listeEcole|count}</span></a></li>
    </ul>
