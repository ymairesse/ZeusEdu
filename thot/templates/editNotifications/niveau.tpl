...
<div class="tab-pane hidden-print" id="tabs-4">
	...
	<table class="table table-condensed tableEdit">
		...
		<tr id="tr_{$nId}">
			...
			<td style="width:20%;">
				<span class="destinataire">Toutes les {$uneNote.destinataire}e</span> <i class="fa fa-circle-thin pull-right urgence{$uneNote.urgence}" title="Niveau d'urgence {$uneNote.urgence}"></i>
			</td>
			<td>
