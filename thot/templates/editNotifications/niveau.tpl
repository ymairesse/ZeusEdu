...
<div class="tab-pane hidden-print" id="tabs-4">
	...
	<table class="table table-condensed tableEdit">
		...
		<tr id="tr_{$uneNote.id}">
			...
			<td style="width:1em">
				<button type="button" class="btn btn-default btn-sm" data-id="{$uneNote.id}">
					<i class="fa fa-pencil-square-o text-success"></i>
				</button>
			</td>
			<td style="width:1em">
				<button type="button" class="btn btn-danger btn-delete btn-sm btnEdit" data-id="{$uneNote.id}">
