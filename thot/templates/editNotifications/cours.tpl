...
<div class="tab-pane hidden-print" id="tabs-2">
	...
	<table class="table table-condensed tableEdit">
		...
		<tr id="tr_{$nId}">
			...
			<td style="width:20%;">
				<span class="destinataire">Cours: {$uneNote.destinataire}</span> <i class="fa fa-circle-thin pull-right urgence{$uneNote.urgence}" title="Niveau d'urgence {$uneNote.urgence}"></i>
			</td>
			<td>
