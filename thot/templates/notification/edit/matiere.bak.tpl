<!-- Notifications à une matière -->
	...
	<table class="table table-condensed tableEdit">
		...
		<tr id="tr_{$nId}" data-id="{$nId}" data-type="matiere">
			<td style="width:1em">
				<input type="checkbox" class="checkDelete" id="check{$nId}" data-id="{$nId}" data-type="matiere">
			</td>
			<td style="width:1em">
				<button type="button" class="btn btn-default btnEdit btn-xs pop" data-id="{$nId}" data-type="matiere" data-content="Modifier cette annonce">
			...
			<td style="width:1em">
				<button type="button" class="btn btn-danger btn-delete btn-xs" data-id="{$nId}" data-type="matiere">
			...
			<td style="width:20%;">
				<span class="destinataire">Matière: {$uneNote.destinataire}</span>
			</td>
			<td>
				{if $uneNote.accuse == 1}
		...
		<tr>
			<th colspan="10">
				...
				<button class="btn btn-warning delModal" type="button" data-type="matiere">
