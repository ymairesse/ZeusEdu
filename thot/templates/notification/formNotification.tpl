...
{if $notification.type == 'cours'}
	<h2>Notification pur le cours {$notification.destinataire}</h2>
{/if}
		...
		<div class="col-md-3 col-sm-12">
			...
			<div class="row panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label for="dateFin">Date de fin (Déf:+1 mois)</label>
					...
					<div class="form-group">
						...
						<input type="checkbox" name="mail" id="mail" class="form-control-inline" value="1"{if isset($notification.mail) && $notification.mail == 1} checked='checked'{/if}
					...
					<div class="form-group">
						...
						<input type="checkbox" name="accuse" id="accuse" class="form-control-inline" value="1"{if isset($notification.accuse) && $notification.accuse == 1} checked='checked'{/if}
						{if $notification.type == 'ecole' || isset($edition)} disabled{/if}>
					...
					<div class="form-group">
						<label for="freeze">Permanent</label>
						...
						<div class="help-group">La notification n'est pas effacée après la date finale</div>
					</div>
