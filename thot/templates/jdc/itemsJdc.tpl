<div class="container-fluid">
    <div class="row">
        <div class="col-md-7 col-xs-12">
            ...
            <form id="formItemsJdc">
                <h3>Mentions disponibles au JDC</h3>

                <div id="tableSort">
                    {include file="jdc/inc/tableSort.tpl"}
                </div>
        ...
        <div class="col-md-5 col-xs-12">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <p>Organisez ici les différentes catégories d'événements à prévoir pour le JDC</p>
                    <p>Utilisez les boutons fléchés pour changer l'ordre des catégories.</p>
                    <p>Les catégories qui sont actuellement utilisées dans le JDC ne peuvent plus être ni modifiées, ni supprimées. Leur ordre d'apparition reste toutefois modifiable.</p>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#tableSort').on('click', '.btn-delCategorie', function(){
            ...
            bootbox.confirm({
                ...
                callback: function(result){
                    if (result == true) {
                        $.post('inc/jdc/deleteCategorie.inc.php', {
                            idCategorie : idCategorie
                        }, function(resultat){
                            $.post('inc/jdc/reloadMentions.inc.php', {},
                            function(resultat){
        ...
        $('#tableSort').on('click', '.btn-saveNewMention', function(){
            ...
            $.post('inc/jdc/saveMention.inc.php', {
                mention : newMention
            }, function(resultat){
                $.post('inc/jdc/reloadMentions.inc.php', {},
                function(resultat){
        ...
        $('#tableSort').on('click', '.btn-down', function(){
            ...
            $.post('inc/jdc/swapOrdreCategoriesJdc.inc.php', {
                ordre1: ordre1,
