...
<div class="box">
    ...
    <select class="form-control" id="selectEleve">
        ...
        <option class="{if $dataTravail.dateRemise != ''}remis{else}nonRemis{/if}" value="{$matricule}" data-photo="{$dataTravail.photo}" data-idtravail="{$dataTravail.idTravail}">
    ...
    <div id="detailsEvaluation" class="hidden">
        ...
        <form class="form-vertical" id="evalTravail">
            <div class="row">
                ...
                <div class="col-xs-3">
                    <button type="button" class="btn btn-primary pull-right" id="saveEval">Enregistrer</button>
                </div>
