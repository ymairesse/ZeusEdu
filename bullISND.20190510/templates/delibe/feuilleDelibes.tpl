<link rel="stylesheet" href="../js/css/sortable-theme-bootstrap.css">
...
<div class="table-responsive">
	<table class="table table-condensed table-hover fdelibe sortable-theme-bootstrap" data-sortable>
		<tr>
